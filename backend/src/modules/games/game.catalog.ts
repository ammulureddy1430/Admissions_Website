...
export const GAME_CATALOG: RegisteredGame[] = [
  ...
  { name: 'Magic Paint', slug: 'magic-paint', description: 'A free-choice real-time creativity and cause-and-effect assessment using animated object coloring.', category: 'Creativity & Cause-and-Effect Assessment', ageGroup: '3–4 Years', difficulty: 'EASY', durationSeconds: 120, thumbnail: '/games/magic-paint.svg', componentName: 'MAGIC_PAINT', gameType: 'REAL_TIME', templateCode: 'GT-MAGIC-PAINT', cognitiveSkill: 'Creativity & Cause and Effect Understanding' },
