...
export default function MagicPaintGame({ disabled=false, durationSeconds=MAGIC_PAINT_DURATION_SECONDS, onComplete, onProgress }:{disabled?:boolean;sound?:boolean;durationSeconds?:number;onComplete:(metrics:MagicPaintScores)=>void|Promise<void>;onProgress?:(metrics:MagicPaintScores)=>void|Promise<void>}) {
