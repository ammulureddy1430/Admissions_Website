...
export default function RescueMissionGame({disabled=false,sound=true,durationSeconds=RESCUE_MISSION_DURATION_SECONDS,onComplete}:{disabled?:boolean;sound?:boolean;durationSeconds?:number;onComplete:(metrics:RescueMissionScores)=>void|Promise<void>}){
